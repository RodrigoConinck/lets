            ...
            <ul>
              <li v-for="(matchItem, index) in matchList" :key="index">
                <img
                  ...
                  alt="foto_perfil"
                  v-if="matchItem.otherUser.foto_perfil"
                  size="150px"
                  :src="matchItem.otherUser.foto_perfil"
                />
                <q-avatar
                  v-else
                  size="150px"
                ...
                <p></p>
                <a
                  :href="getWhatsAppUrl(matchItem.otherUser.whatsapp)"
                  @click.prevent="openWhatsApp(matchItem.otherUser.whatsapp)"
                  target="_blank"
